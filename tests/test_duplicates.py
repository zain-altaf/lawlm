...
try:
    ...
    print("Please install dependencies from data-ingestion/requirements.txt:")
    print("  pip install -r data-ingestion/requirements.txt")
...
def load_config():
    ...
    config_path = os.path.join(os.path.dirname(__file__), '..', 'data-ingestion', 'config.yml')
